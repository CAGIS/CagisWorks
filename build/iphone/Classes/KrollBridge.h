...
@interface CityWorksObject : KrollCoverageObject {
#else
@interface CityWorksObject : KrollObject {
#endif
@private
...
extern NSString * CityWorks$ModuleRequireFormat;
