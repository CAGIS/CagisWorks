...
// in simulator we redefine to format for CityWorks Developer console
...
{\
	NSString * exceptionName = [@"org.cityworks." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.cityworks";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICityWorksNativeItemNone = -1, 
	UICityWorksNativeItemSpinner = -2,
	UICityWorksNativeItemProgressBar = -3,
	
	UICityWorksNativeItemSlider = -4,
	UICityWorksNativeItemSwitch = -5,
	UICityWorksNativeItemMultiButton = -6,
	UICityWorksNativeItemSegmented = -7,
	
	UICityWorksNativeItemTextView = -8,
	UICityWorksNativeItemTextField = -9,
	UICityWorksNativeItemSearchBar = -10,
	
	UICityWorksNativeItemPicker = -11,
	UICityWorksNativeItemDatePicker = -12,
	
	UICityWorksNativeItemInfoLight = -13,
	UICityWorksNativeItemInfoDark = -14,
	
	UICityWorksNativeItemDisclosure = -15,
	
	UICityWorksNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all CityWorks instances of
