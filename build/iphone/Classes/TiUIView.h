...
/**
 Base class for all CityWorks views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the CityWorks view hierarchy (such as wrapped iOS UIViews) was touched.
