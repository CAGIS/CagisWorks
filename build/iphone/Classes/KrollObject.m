...
//@interface CityWorksObject : NSObject
//@end

@interface CityWorksObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CityWorksObject class]])
		{
			for (NSString *key in [[(CityWorksObject*)o modules] allKeys])
			{
