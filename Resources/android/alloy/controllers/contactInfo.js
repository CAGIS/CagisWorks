...
function Controller() {
    ...
    $.__views.contactInfo.add($.__views.__alloyId3);
    $.__views.buttonVw = Ti.UI.createView({
        height: Titanium.UI.SIZE,
        layout: "composite",
        id: "buttonVw"
    });
    $.__views.__alloyId3.add($.__views.buttonVw);
    ...
    $.__views.__alloyId5.add($.__views.txtFirstName);
    ...
    $.__views.__alloyId6.add($.__views.txtLastName);
    ...
    $.__views.__alloyId7.add($.__views.txtPhone);
    ...
    $.__views.__alloyId3.add($.__views.contactInfoTableView);
